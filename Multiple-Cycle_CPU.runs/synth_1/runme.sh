...
HD_PWD='D:/Undergraduate/2022-2023-1/Multiple-Cycle_CPU/Multiple-Cycle_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_display.tcl
