...
HD_PWD='D:/Undergraduate/2022-2023-1/Multiple-Cycle_CPU/Multiple-Cycle_CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu_display.tcl -notrace
